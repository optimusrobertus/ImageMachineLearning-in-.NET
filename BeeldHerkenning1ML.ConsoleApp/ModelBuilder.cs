...
namespace BeeldHerkenning1ML.ConsoleApp
{
    ...
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\rober\AppData\Local\Temp\d261c0f6-5136-4d9b-893d-32b811cb251c.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\rober\AppData\Local\Temp\MLVSTools\BeeldHerkenning1ML\BeeldHerkenning1ML.Model\MLModel.zip";
        ...
        {
            FileInfo _dataRoot = new FileInfo(typeof(BeeldHerkening1.Program).Assembly.Location);
